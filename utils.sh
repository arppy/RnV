...
nohup bash -c 'python train_syllable_rhythm_model.py Szindbad /home/berta/data/Szindbad/wav_preprocess_pydub/ Szindbad/Szindbad-segmenter.pth Szindbad/' > nohup_train_syllable_Szindbad.log 2>&1 &
