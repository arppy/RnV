...
nohup bash -c 'python train_urhythmic_rhythm_model.py Szindbad global Szindbad/Szindbad-wavlm/ Szindbad/Szindbad-segmenter.pth Szindbad/' > nohup_train_uryglobal_Szindbad.log 2>&1 &
...
nohup bash -c 'python train_syllable_rhythm_model.py Szindbad /home/berta/data/Szindbad/wav_preprocess_pydub/ Szindbad/Szindbad-wavlm/ Szindbad/Szindbad-segmenter.pth Szindbad/' > nohup_train_syllable_Szindbad.log 2>&1
...
nohup bash -c  'for i in C_{001..050}; do CUDA_VISIBLE_DEVICES=3 python convert_by_speaker.py "$i" Szindbad urhythmic fine HunDys/HunDys-wavlm/ Szindbad/Szindbad-wavlm/ /home/berta/models/vocoder-hifigan/wavlm-hifigan-prematch_g_02500000/ Szindbad/Szindbad-segmenter.pth knnvc HunDys/HunDys_knnvc_urhythmic_fine_wav /home/berta/data/HungarianDysartriaDatabase/preprocessed_rnv_wav/; done' > nohup_convert_urhythmicfine_HunDys.log 2>&1 &
